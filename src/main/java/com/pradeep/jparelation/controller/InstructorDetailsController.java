...
public class InstructorDetailsController {
	...
	@PostMapping("{id}")
    public InstructorDetail createInstructor(@PathVariable(value = "id") Long instructorId,@RequestBody InstructorDetail instructorDetail) throws ResourceNotFoundException {
